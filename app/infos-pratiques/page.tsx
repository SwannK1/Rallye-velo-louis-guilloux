...
const description =
  "Rendez-vous, parcours et pauses du Rallye Vélo Louis Guilloux, le 20 septembre 2026 à Saint-Brieuc.";
...
export default function InfosPratiquesPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 sm:py-16">
      ...
      >
        L&apos;essentiel à savoir le jour du rallye.
      </p>
      ...
      <div className="flex flex-col gap-6">
            ...
            {parcoursData.map((parcours) => (
              ...
              >
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center px-4 py-2 text-sm font-sans font-medium rounded-lg transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"
        ...
        <Block icon={<IconPicnic />} title="Repas / pauses">
          <p style={{ color: "var(--ink-light)" }}>
            ...
            <strong>Villa Rohannec&apos;h</strong>, avec présentation du lieu
            et activités littéraires.
          </p>
        </Block>
